...
public class CorrectAction : MonoBehaviour
{
    ...
    public void HandMove_object(Transform startPos, Transform endPos) //startPos, endPos are the cube transform, cube->pivot->hand
    {
        ...
        //else
        //{
        //    hand_height = 2f * journeyLength * 0.5f * (fracJourney - Mathf.Pow(fracJourney, 2.0f)); // y=B*[0.25-(x-0.5)^2]=B*(x-x^2), x range from (0-1) create a simple curve to move hand
        //}
